					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'div',
								{ className: 'col-md-4' },
								_react2.default.createElement('img', { src: this.props.userData.avatar_url, className: 'thumbnail', style: { with: '50%' } })
							),
							_react2.default.createElement(
								'div',
								{ className: 'col-md-4 col-xs-offset-1' },
								_react2.default.createElement(
									'div',
									{ className: 'row' },
									_react2.default.createElement(
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          this.props.userRepos.map(function (repo) {
	            return _react2.default.createElement(_Repo2.default, _extends({ repo: repo, key: repo.id }, _this2.props));
	          })
	        )
	      );
	    }
